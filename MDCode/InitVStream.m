...
AddCircAtomicArray(4, 0, 0, 0, 0, 0, T, 0);
...
AddParticleStream(2, 0, 12, -pi / 2, 1, Ep * C.q_0, 5);

AddParticleStream(2, 0, -12, pi / 2, 1, Ep * C.q_0, 5);

AddParticleStream(2, 10, 0, -pi , 1, Ep * C.q_0, 5);

AddParticleStream(2, -10, 0, 0 , 1, Ep * C.q_0, 5);
